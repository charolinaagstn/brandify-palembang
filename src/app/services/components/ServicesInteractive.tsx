...
export default function ServicesInteractive() {
  ...
  const processSteps: TimelineStep[] = [
  {
    ...
    description: 'Kami mendengarkan kebutuhan bisnis Anda, memahami target audience, dan mendiskusikan visi brand yang ingin dicapai. Sesi ini memastikan kami memiliki pemahaman yang sama tentang tujuan proyek.',
    duration: '1-2 hari',
    icon: 'ChatBubbleLeftRightIcon'
  },
  {
    title: 'Riset & Konsep',
    description: 'Tim kami melakukan riset kompetitor, analisis tren industri, dan mengembangkan konsep desain yang sesuai dengan positioning brand Anda di pasar Palembang.',
    duration: '2-3 hari',
    icon: 'MagnifyingGlassIcon'
  },
  {
    title: 'Desain & Presentasi',
    description: 'Kami membuat beberapa alternatif desain berdasarkan brief dan riset. Setiap konsep dipresentasikan dengan penjelasan reasoning di balik setiap keputusan desain.',
    duration: '3-5 hari',
    icon: 'PaintBrushIcon'
  },
  {
    title: 'Revisi & Finalisasi',
    description: 'Berdasarkan feedback Anda, kami melakukan revisi hingga desain sempurna. Kami memastikan setiap detail sesuai dengan ekspektasi dan siap untuk implementasi.',
    duration: '2-4 hari',
    icon: 'ArrowPathIcon'
  },
  {
    title: 'Delivery & Support',
    description: 'File final dikirimkan dalam berbagai format yang dibutuhkan, lengkap dengan panduan penggunaan. Kami juga menyediakan support untuk memastikan implementasi berjalan lancar.',
    duration: '1 hari',
    icon: 'CheckBadgeIcon'
  }];
  ...
  const faqs: FAQ[] = [
  {
    ...
    answer: 'Waktu pengerjaan bervariasi tergantung paket yang dipilih. Paket Basic umumnya 3-7 hari kerja, Standard 7-14 hari kerja, dan Premium 14-30 hari kerja. Timeline spesifik akan dikonfirmasi saat konsultasi awal berdasarkan kompleksitas proyek dan antrian pekerjaan.'
  },
  {
    question: 'Apakah saya bisa request revisi setelah desain selesai?',
    answer: 'Ya, setiap paket memiliki kuota revisi yang berbeda. Paket Basic mendapat 2-3 kali revisi, sedangkan paket Standard dan Premium mendapat revisi unlimited selama masa pengerjaan. Revisi major setelah approval final akan dikenakan biaya tambahan.'
  },
  {
    question: 'Format file apa saja yang akan saya terima?',
    answer: 'Untuk paket Basic, Anda akan menerima file PNG dan JPG. Paket Standard dan Premium mendapat file lengkap termasuk format vektor (AI, EPS, SVG), PDF, dan file editable. Semua file dikirim dalam resolusi tinggi siap cetak dan digital.'
  },
  {
    question: 'Apakah harga sudah termasuk biaya cetak?',
    answer: 'Tidak, harga yang tertera adalah untuk jasa desain saja. Biaya cetak atau produksi fisik tidak termasuk dalam paket. Namun, kami dapat membantu koordinasi dengan percetakan rekanan dan memberikan rekomendasi vendor terpercaya di Palembang.'
  },
  {
    question: 'Bagaimana cara pembayaran untuk layanan desain?',
    answer: 'Pembayaran dilakukan dengan sistem DP 50% di awal untuk memulai proyek, dan pelunasan 50% sebelum file final dikirimkan. Kami menerima transfer bank, e-wallet, dan QRIS. Invoice resmi akan diberikan untuk setiap transaksi.'
  },
  {
    question: 'Apakah saya mendapat hak cipta penuh atas desain?',
    answer: 'Ya, setelah pembayaran lunas, Anda mendapat hak cipta penuh (full ownership) atas desain yang telah dibuat. Anda bebas menggunakan, memodifikasi, dan mengkomersialkan desain tersebut tanpa batasan. Kami hanya meminta izin untuk menampilkan karya di portfolio.'
  },
  {
    question: 'Bagaimana jika saya tidak puas dengan hasil desain?',
    answer: 'Kepuasan klien adalah prioritas kami. Jika setelah revisi maksimal Anda masih belum puas, kami akan melakukan diskusi mendalam untuk memahami ekspektasi. Dalam kasus tertentu, kami dapat menawarkan refund parsial atau mengulang dari konsep baru sesuai kebijakan yang berlaku.'
  },
  {
    question: 'Apakah ada paket khusus untuk UMKM dengan budget terbatas?',
    answer: 'Ya, kami memahami tantangan UMKM. Selain paket Basic yang sudah terjangkau, kami juga menawarkan program cicilan untuk paket Standard dan Premium. Hubungi kami untuk diskusi solusi yang sesuai dengan budget dan kebutuhan bisnis Anda.'
  }];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-text-secondary mb-8 leading-relaxed">
              Dari logo hingga website, kami menyediakan solusi desain lengkap yang membantu bisnis Anda tampil profesional dan menarik perhatian pelanggan
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="px-8 py-4 bg-card text-foreground font-semibold rounded-lg border-2 border-border hover:border-accent transition-all duration-300 inline-flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-text-secondary text-lg">
                Metodologi yang transparan dan terstruktur untuk hasil maksimal
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-text-secondary text-lg mb-8">
                Lihat bagaimana kami membantu UMKM Palembang tampil lebih profesional
              </p>
            </div>
            ...
            <div className="text-center mt-12">
              <a
                href="/portfolio-showcase"
                className="inline-flex items-center gap-2 px-8 py-4 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all duration-300 shadow-md hover:shadow-lg">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 opacity-90">
              Bergabunglah dengan ratusan UMKM Palembang yang telah mempercayai kami untuk membangun identitas visual mereka
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/order-form"
              ...
              <a
                ...
                className="px-8 py-4 bg-transparent text-white font-semibold rounded-lg border-2 border-white hover:bg-white/10 transition-all duration-300 inline-flex items-center justify-center gap-2">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <div className="text-text-secondary text-sm">Proyek Selesai</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-accent mb-2">150+</div>
                <div className="text-text-secondary text-sm">Klien Puas</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-accent mb-2">98%</div>
                <div className="text-text-secondary text-sm">Tingkat Kepuasan</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-accent mb-2">5 Tahun</div>
                <div className="text-text-secondary text-sm">Pengalaman</div>
              </div>
            </div>
          </div>
        </div>
