  ...
  const services: Service[] = [
    {
      ...
      description: 'Buat Brand Pada usaha and dengan memberikan logo sebagai identitas',
      icon: 'SparklesIcon',
    ...
    },
    {
      ...
      description: 'Sebarkan informasi UMKM anda dengan poster dan lainnya',
      icon: 'CubeIcon',
      image: '/hero-home/poster1.jpg',
    ...
    },
    {
      ...
      description: 'Yuk animasikan UMKM anda dengan Efek Animasi Multimedia Dan lainnya',
    ...
    },
    {
      ...
      description: 'Cocok untuk semua jenis UMKM',
      icon: 'MegaphoneIcon',
